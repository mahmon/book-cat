...
public class BackgroundTask extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... params) {
        ...
        String login_url = "http://www.mahmon.com/login.php";
        ...
        if(method.equals("register")) {
            ...
            String login_user_email = params[1];
            String login_user_password = params[2];
            try {
                ...
                BufferedWriter bufferedWriter =
                        new BufferedWriter(new OutputStreamWriter(outputStream, "UTF-8"));
                String data = URLEncoder.encode("login_user_email", "UTF-8")
                        + "=" + URLEncoder.encode(login_user_email, "UTF-8") + "&"
